...
export default function Home() {
  return (
    <div className="bg-white">
      ...
      <main className="flex flex-col lg:flex-row items-center justify-between p-6 bg-gray-300">
        {/* Parte Esquerda - Links */}
        <div className="flex flex-col items-center lg:w-1/2">
          <Title as="h2">Não tem uma conta?</Title>

          <div className="space-y-4 mt-8 text-center">
            <p className="text-gray-800">Bem-vindo à nossa rede social FrontierLess! Aqui você vai encontrar
            sua viagem para intercâmbio, com todas as informações atualizadas!</p>
            <p className="text-gray-800">Se você é novo por aqui e quer ter essa experiência, aproveite e se cadastre clicando abaixo:</p>
            ...
            <p className="text-gray-800">Se você já tem uma conta, pode acessá-la novamente com o link abaixo!</p>
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between p-6 mt-6 bg-gray-300">
        ...
        <div className="flex flex-col items-center lg:w-1/2">
          ...
          <div className="space-y-4 mt-8 text-center">
            <p className="text-gray-800">Para acessar o Feed do nosso site e obter mais informações sobre projetos para viagens incríveis,
              siga o link abaixo!
            </p>
